...
export default function MouseFollower() {
  ...
  useEffect(() => {
    ...
    const handleMouseOver = (e) => {
      ...
      // We'll consider it hovering text or interactive
  ...
  return (
    <div className="fixed inset-0 pointer-events-none z-[9999] overflow-hidden mix-blend-screen px-4">
      ...
      {/* Extreme ambient glow in background following standard spring */}
      <motion.div
        className="absolute w-[400px] h-[400px] rounded-full bg-primary-600/10 blur-[80px]"
        style={{
          x: cursorX,
          y: cursorY,
          translateX: '-50%',
